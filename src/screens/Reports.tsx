...
import { Upload, ExternalLink, Trash2, FileCode } from 'lucide-react'
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', height: '100%', overflow: 'hidden' }}>
      ...
      <div style={{ padding: '16px 20px', borderBottom: '1px solid var(--border-subtle)', flexShrink: 0 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: '12px', flexWrap: 'wrap' }}>
          <div style={{ flex: 1 }}>
            ...
            <p style={{ fontSize: '12px', color: 'var(--text-secondary)' }}>{filtered.length} report{filtered.length !== 1 ? 's' : ''} · HTML files, open in browser</p>
          </div>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px' }}>
        {/* Drop zone — shown when no reports or always available */}
        <div
                ...
                >
                  ...
                  <div style={{ display: 'flex', gap: '6px', marginTop: 'auto' }}>
                    <a
                      ...
                      style={{ flex: 1, display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', padding: '7px', background: 'var(--accent)', color: '#000', borderRadius: '6px', fontSize: '12px', fontWeight: 600, textDecoration: 'none', fontFamily: 'var(--font-ui)' }}
                    >
